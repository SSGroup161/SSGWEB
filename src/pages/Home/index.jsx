...
const Home = () => {
    ...
    return (
        <div className="max-w-screen-3xl m-auto">
            ...
            <FAB />
            <Toaster richColors />
            <section className="flex mt-28 items-center justify-center">
                <div className="flex flex-col md:flex-row relative items-center justify-center max-w-screen-2xl m-auto">
                    <div
                    ...
                    >
                        <div className="lg:px-24 px-10">
                            <div className="">
                                ...
                                <h1 className="font-aref uppercase text-[#D2AC47] text-2xl lg:text-5xl mt-2 lg:mt-4">
                                    the magic of beauty
                                </h1>
                                <h1 className="font-aref uppercase text-[#D2AC47] text-xl lg:text-3xl mt-2 lg:mt-4">
                                    happens
                                </h1>
                            </div>
                            <div className="mt-8 font-roboto text-[#A18E64] font-light">
                                ...
                                brands (Shellasaukia.co, SS Skin, SS Your Make Up, SS Love Kids, and SS Travel Indonesia) engaged in beauty, fashion, and
                            ...
                            <div className="flex mt-8 gap-6 md:gap-10 mb-28">
                                <div
                                    className="w-[8rem] lg:w-[12rem] h-14 bg-[#D2AC47] text-white cursor-pointer rounded-md flex justify-center items-center transition-all duration-300 hover:bg-[#BA9021]"
                                    onClick={() => scrollToDown()}
                                >
                                    <h1 className="font-roboto">Get Started</h1>
                                </div>
                                <div
                                    className="w-[8rem] lg:w-[12rem] h-14 bg-white border-2 border-[#D2AC47] text-[#D2AC47] cursor-pointer rounded-md flex justify-center items-center transition-all duration-300 hover:bg-[#fff8ea]"
            ...
            <section className="flex flex-col justify-start items-center">
                <h1
                    className="text-[#D2AC47] font-roboto md:mt-28 text-2xl md:text-3xl mb-8 md:mb-14"
                    data-aos="fade-up"
                    data-aos-duration="1500"
                >
                    Our Brand
            ...
            <section className="flex flex-col-reverse md:flex-row justify-between items-center mt-48 lg:px-56 gap-10 md:px-12">
                <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-10 w-full 2xl:max-w-screen-lg m-auto">
                    <div
                        className="px-10"
                        data-aos="fade-up"
                        data-aos-duration="1500"
                    >
                        ...
                        <div className=" md:w-[26rem] lg:w-[30rem]">
            ...
            <section className="flex flex-col-reverse md:flex-row justify-between items-center mt-40 md:px-10 lg:px-56">
                <div className="flex flex-col-reverse md:flex-row justify-between items-center w-full max-w-screen-lg m-auto px-10">
                    <div data-aos="fade-up" data-aos-duration="1500">
                        <img src={imagebeauty} alt="imagebeauty" width={400} />
                    </div>
                    <div
                        className="md:w-[24rem] lg:w-[30rem]"
                        data-aos="fade-up"
                        data-aos-duration="1500"
                    >
                        <h1 className="text-[#D2AC47] font-roboto text-3xl">
                        ...
                        <p className="font-roboto font-light text-[#A18E64] md:mt-10 mt-6">
                            ...
                            cosmetics and beauty industry but also expands its
                            reach into the contemporary and trendy world of
                            fashion. With the same innovative spirit, SS Group
                            creates a harmonious blend of beauty and style in
                            its products.
                        </p>
                    </div>
                </div>
            ...
            <section className="flex flex-col-reverse md:flex-row-reverse justify-between items-center mt-32 md:px-10 lg:px-56 gap-10">
                <div className="flex flex-col-reverse md:flex-row-reverse justify-between items-center gap-10 w-full max-w-screen-lg m-auto px-10">
                    <div
