...
const AssetLogin = "/Asset3.svg";

const Login = () => {
    return (
        <>
            <section className="h-screen w-screen bg-[#D2AC47] flex justify-between relative">
                <div className="bg-transparent h-screen w-96">
                    <svg
                        width="25"
                        height="60"
                        viewBox="0 0 314 653"
                        ...
                        className={`cursor-pointer ms-60 mt-10`}
                    >
                        <path
                ...
                <div className="bg-white w-[60rem] h-screen rounded-s-[4rem] flex justify-center items-center">
                    <form>
                        <h1 className="text-4xl font-semibold text-[#D2AC47] mb-8">
                            Login
                        </h1>
                        <div className="flex flex-col w-96 gap-2">
                            <label className="relative cursor-pointer">
                                <input
                                    type="text"
                                    placeholder="Input"
                                    className="w-full h-12 px-4 text-black border-black border-2 rounded-lg border-opacity-50 focus:outline-none focus:border-[#D2AC47] placeholder-gray-300 placeholder-opacity-0 transition duration-200"
                                    required
                                />
                                <span className="text-gray-400 text-opacity-80 bg-white absolute left-3 top-3 px-1 transition duration-200 input-text">
                                    Username
                                </span>
                            </label>
                            <label className="relative cursor-pointer mt-4">
                                <input
                                    ...
                                    required
                                />
                                <span className="text-gray-400 text-opacity-80 bg-white absolute left-3 top-3 px-1 transition duration-200 input-password">
                                    Password
                                </span>
                            </label>
                            <button
                                type="submit"
                                className="w-full h-12 bg-[#D2AC47] mt-6 rounded-lg text-white font-roboto font-medium hover:bg-white hover:border-2 hover:border-[#D2AC47] hover:text-[#D2AC47]"
                            >
                                Login
                            </button>
                        </div>
                ...
                <img
                    src={AssetLogin}
                    alt="AssetLogin"
                    className="absolute w-[40rem] left-10 top-20"
                    width={100}
                    height={100}
                />
            </section>
